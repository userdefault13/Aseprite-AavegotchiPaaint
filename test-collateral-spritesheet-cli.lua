-- Test Collateral Spritesheet Generator via CLI
-- Usage: aseprite -b --script test-collateral-spritesheet-cli.lua

local assetsPath = "/Users/juliuswong/Dev/Aseprite-AavegotchiPaaint"
local collateral = "amAAVE"
local jsonPath = assetsPath .. "/JSONs/Collaterals/collateral-amaave-1764616862816.json"

print("=== Testing Collateral Spritesheet Generator ===")
...
print("Attempting to generate collateral spritesheet...")
print("")

local sprite, err
local ok, result1, result2 = pcall(function()
    return SpriteSheetGenerator.generateCollateralSpriteSheet(collateral, jsonPath, assetsPath)
end)
...
-- Save the result
local outputPath = assetsPath .. "/Output/test-collateral-spritesheet-" .. collateral:lower() .. ".aseprite"
