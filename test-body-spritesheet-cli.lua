-- Test Body Spritesheet Generator via CLI
-- Usage: aseprite -b --script test-body-spritesheet-cli.lua
...
print("=== Testing Body Spritesheet Generator ===")
...
print("Attempting to generate body spritesheet...")
print("")

local sprite, err
local ok, result1, result2 = pcall(function()
    return SpriteSheetGenerator.generateBodySpriteSheet(collateral, jsonPath, assetsPath)
end)
...
-- Save the result
local outputPath = assetsPath .. "/Output/test-body-spritesheet-" .. collateral:lower() .. ".aseprite"
